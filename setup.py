...
# Arguments marked as "Required" below must be included for upload to PyPI.d
...
setup(
    ...
    keywords='neuroimaging fMRI subcortical brain quality',  # Optional
